            ...
            async function predict() {
                ...
                window.setInterval(function(){
                    ...
                    if(y >= f){
                        ...
                        sendemail();
                        play();
                        alert('It has been ' + e + ' hours, time to get up!' + 'You can use these stretching exercises to help keep you body fit while at work: <a href="http://docs.google.com/gview?url=https://cdn.jsdelivr.net/gh/Megaman222111/standup-css@main/Stretching_Poster_4-2020.pdf&embedded=true">http://docs.google.com/gview?url=https://cdn.jsdelivr.net/gh/Megaman222111/standup-css@main/Stretching_Poster_4-2020.pdf&embedded=true</a>');
                    }
                  }, 1000);
                  function sendemail(){
                  Email.send({
